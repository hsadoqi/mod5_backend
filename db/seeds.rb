...
second = Project.create(title: 'hello', img: 'https://www.w3schools.com/w3images/nature.jpg', description: 'hello', manager: arren)
third = Project.create(title: 'hello', img: 'https://www.w3schools.com/w3images/lights.jpg', description: 'hello', manager: arren)
fourth = Project.create(title: 'hello', img: 'https://techcrunch.com/wp-content/uploads/2018/03/gettyimages-705351545.jpg?w=730&crop=1', description: 'hello', manager: arren)
fifth = Project.create(title: 'hello', img: 'https://demo.phpgang.com/crop-images/demo_files/pool.jpg', description: 'hello', manager: cristina)
